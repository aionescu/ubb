...
def main():
	...
	for p in range(3, 6 + 1):
		...
		print(f"n = {n}: ", end = "")
		calculateTime(DictGraph, n, m)

	print("Inbound + outbound dict:")
	for p in range(3, 6 + 1):
		n = 10 ** p
		m = n * 10

		print(f"n = {n}: ", end = "")
		calculateTime(DoubleDictGraph, n, m)
