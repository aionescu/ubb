...
public class MaintainerServiceImpl implements MaintainerService{
    ...
    @Override
    @Transactional
    public Maintainer addMaintainerAnyCase(Maintainer maintainer) {
        return this.maintainerRepo.save(maintainer);
    }
    ...
    public Maintainer getOneMaintainer(Long ID) {
        return this.maintainerRepo.findById(ID).orElseThrow(() -> new AppException("Non-existent maintainer !"));
    }
}
