...
public interface Repository<ID, T extends BaseEntity<ID>> {
     ...
     * @return an {@code Optional} - null if the entity was saved otherwise (e.g. id
     *         already exists) returns the entity.
     ...
     *
     * @param entity must not be null.
     * @return an {@code Optional} - null if the entity was updated otherwise (e.g.
     *         id does not exist) returns the entity.
     * @throws IllegalArgumentException if the given entity is null.
     * @throws ValidatorException       if the entity is not valid.
     */
