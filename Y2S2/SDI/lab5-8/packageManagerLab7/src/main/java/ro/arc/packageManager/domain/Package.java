...
public class Package extends BaseEntity<Long>  {
    ...
    public Package( String name, String description, String sourceRepo, String license) {
    ...
    public static class PackageFormat implements FormatXML<Package>
    {
        ...
        public Package fromXML(Element element) {
            ...
            Package p = new Package(name.getTextContent(), description.getTextContent(), sourceRepo.getTextContent(),license.getTextContent());
            p.setID(parseLong(id));
            return p;
        }
    }
