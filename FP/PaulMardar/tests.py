...
class Tests(unittest.TestCase):
    ...
    def test_clase(self):
        ...
        test_p.phone_number = '1231'
        test_p.name ='AB1L'
        print('unit tests are working in MY FAVOR ')
        print(test_p)
        print(test_a)
        test_a1 = Activity(21 ,[100,1],'15.12','1400','Nimicuri')
        assert (test_a == test_a1)
        test_a1.description ='nothing'
    ...
    def test_delete(self):
        ...
        test_del.add_person(2, 'Paul', 112)
        assert (repository.read(2).name == 'Paul')
        print('FINAL DELETE tests')

    def test_repo_persoane(self):
        pass
