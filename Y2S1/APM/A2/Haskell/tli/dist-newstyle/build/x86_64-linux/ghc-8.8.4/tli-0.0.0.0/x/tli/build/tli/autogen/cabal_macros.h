...
/* package tli-0.0.0.0 */
#ifndef VERSION_tli
#define VERSION_tli "0.0.0.0"
#endif /* VERSION_tli */
#ifndef MIN_VERSION_tli
#define MIN_VERSION_tli(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_tli */
...
#define CURRENT_COMPONENT_ID "tli-0.0.0.0-inplace-tli"
